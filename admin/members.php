	...
	*/
	...
	if (isset($_SESSION['Username'])) {
		...
		if ($do == 'Manage') { // Manage Members Page
			...
			$stmt = $con->prepare("SELECT * FROM users WHERE GroupID != 0 $query ORDER BY UserID DESC");
      ...
      $avatarNam = explode(".",$avatarName);
      $lowerExt =   strtolower(end($avatarNam) );
				...
				if (! empty($avatarName) && ! in_array($lowerExt, $avatarAllowedExtension)) {
